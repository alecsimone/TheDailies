	...
	render() {
		return(
			<section id="prospectForm">
				...
				<header id="AddProspectInstructions">Limit 2 submissions per day. Currently only Twitch clips, tweets, Youtube videos, Gfycats, and Gifyourgame.com links are supported.</header>
