...
function generateHash($length = 64) {
	$string = generateString('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', 64);
	$hash = '_' . $string;
	return $hash;
}
function generateString($charset = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', $length = 64) {
	$string = '';
